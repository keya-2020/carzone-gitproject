...
class Car(models.Model):
    ...
    car_title = models.CharField(max_length=255, default="")
    state = models.CharField(choices=state_choice, max_length=100, default="")
    ...
    vin_no = models.CharField(max_length=100, default="")
    milage = models.IntegerField()
    fuel_type = models.CharField(max_length=50, default="")
    no_of_owners = models.CharField(max_length=100, default="")
